...
def xgb_evaluate_fine(max_depth, gamma, colsample_bytree, subsample, min_child_weight, 
    reg_lambda, reg_alpha, eta, boost_rounds, scale_pos_weight, nfold=10):
    """
